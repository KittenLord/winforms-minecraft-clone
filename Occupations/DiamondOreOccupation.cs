...
{
    public class DiamondOreOccupation : Mineable, IOccupation
    {
        public DiamondOreOccupation(int resourceCount, TileCoordinates sourceCoordinates, Item resource, List<Item> toolFilter) : base(resourceCount, sourceCoordinates, resource, toolFilter)
        {
        }

        public OccupationType Type => OccupationType.DiamondOre;

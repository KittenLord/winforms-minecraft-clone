...
{
    public class NetheriteOccupation : Mineable, IOccupation
    {
        public NetheriteOccupation(int resourceCount, TileCoordinates sourceCoordinates, Item resource, List<Item> toolFilter) : base(resourceCount, sourceCoordinates, resource, toolFilter)
        {
        }

        public OccupationType Type => OccupationType.Netherite;
